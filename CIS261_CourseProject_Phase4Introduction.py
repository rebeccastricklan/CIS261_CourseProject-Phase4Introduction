#Rebecca Stricklan
#CIS261 Course Project-Phase3
#Phase3: Using Files to Store and Retrieve Data
    ...
    while True:
        ...
        while True:
            ...
            if (str(rundate).upper() != "ALL"):
                ...
                print(fromdate, todate, empname, f"{hours:,.2f}", f"{hourlyrate:,.2f}", f"{grosspay:,.2f}", f"{taxrate:,.1%}", f"{incomtax:,.2f}", f"{netpay:,.2f}")
                TotEmployees += 1
                TotHours += hours
